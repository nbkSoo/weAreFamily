...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4ROIEVyJU8Om"; // AccessKeyId

        $accessKeySecret = "2lXGTsi7RqKJi2u7FJTk1sKHawtqUO"; // AccessKeySecret
...
//        ajax_return("200","发送成功",$_SESSION);
    ...
    public static function querySendDetails() {
        ...
        // 必填，短信接收号码
        $request->setPhoneNumber("13611243845");

        // 必填，短信发送日期，格式Ymd，支持近30天记录查询
        $request->setSendDate("20180130");
